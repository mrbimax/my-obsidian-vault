Для реализации TCP-соединения в Go используется стандартный пакет `net`. Ниже приведен минимальный и самый простой пример, состоящий из двух частей: **Сервера** и **Клиента**.
