...
Ingress работает на [[L7 модели OSI. Прикладной уровень|седьмом, прикладном, уровне]] сетевой [[Модель OSI|модели OSI]]. Если необходимо занять третий уровень — сетевой, используйте другие способы публикации приложений из списка:
